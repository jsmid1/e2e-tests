...
* Tokens
  * Github Token with the following permissions
    * `repo`
    * `delete_repo`
  * Valid quay token(Robot account) where to push AppStudio components images generated by the e2e framework
...
Our automated tests running in CI create a lot of repositories in our redhat-appstudio-qe github org.
